...
public class ServerData : RemoteObjectBase
{
	...
	internal Dictionary<InventoryName, IntPtr> PlayerInventories { get; } = new Dictionary<InventoryName, IntPtr>();
	...
	protected override void UpdateData(bool hasAddressChanged)
	{
		...
		InventoryArrayStruct[] inventoryData = handle.ReadStdVector<InventoryArrayStruct>(handle.ReadMemory<ServerDataStructure>((nint)base.Address + 39168).PlayerInventories);
		PlayerInventories.Clear();
