...
public class GameStates : RemoteObjectBase
{
	...
	public Dictionary<IntPtr, GameStateTypes> AllStates { get; } = new Dictionary<IntPtr, GameStateTypes>();
	...
	internal override void ToImGui()
	{
		...
		{
			foreach (KeyValuePair<IntPtr, GameStateTypes> state in AllStates)
			{
	...
	protected override void UpdateData(bool hasAddressChanged)
	{
		...
		{
			IntPtr cStateAddr = reader.ReadMemory<IntPtr>((nint)reader.ReadMemory<GameStateOffset>(myStaticObj.GameState).CurrentStatePtr.Last - 16);
